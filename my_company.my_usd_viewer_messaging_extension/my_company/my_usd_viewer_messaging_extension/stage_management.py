...
class StageManager:
    ...
    def _on_play(self, event: carb.events.IEvent):
        """
        Handler for `resetStage` event.
        ...
        A success message is sent if all attributes are succesfully reset, and error message is set otherwise.
        """
        if event.type == carb.events.type_from_string("play"):
            timeline = omni.timeline.get_timeline_interface()
            timeline.play()

    def _on_stop(self, event: carb.events.IEvent):
        """
        Handler for `resetStage` event.
        ...
        A success message is sent if all attributes are succesfully reset, and error message is set otherwise.
        """
        if event.type == carb.events.type_from_string("stop"):
            timeline = omni.timeline.get_timeline_interface()
            timeline.stop()
